...
export function config(){
  ...
  return {origins,appOrigin:origins[0],google:googleConfig(origins[0]),secureCookies:origins.every(x=>x.startsWith('https://')),port:Number(process.env.API_PORT||3001)};
}
